            ...
            q_allowed_location = Q(
                (
                    ...
                    extend_allowed_locations(
                        self.get_allowed_ids(user), False, loc_types
                    ),
                )
...
class Location(core_models.VersionedModel, core_models.ExtendableModel):
    ...
    code = models.CharField(
        db_column="LocationCode", max_length=50, blank=True, null=True, unique=True
    )
...
class HealthFacility(core_models.VersionedModel, core_models.ExtendableModel):
    ...
    lab_services_pricelist = models.ForeignKey(
        "medical_pricelist.LaboratoryServicesPricelist",
        models.DO_NOTHING,
